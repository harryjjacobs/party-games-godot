extends "res://state/GameState.gd"

const Message = preload("res://comms/Message.gd")

export(int) var max_players = 10
export(int) var min_players = 2

onready var player_icon_display: PlayerIconDisplay = $"PlayerIconDisplay"
